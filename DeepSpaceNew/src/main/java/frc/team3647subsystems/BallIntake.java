...
{
	public static Solenoid extensionCylinder = new Solenoid(Constants.ballIntakeSolenoidPin);
	public static Solenoid extensionCylinder2 = new Solenoid(Constants.ballIntakeSolenoid2Pin);
