...
// 	private static WPI_TalonSRX armSRX = new WPI_TalonSRX(Constants.armSRXPin);	
// 	private static CANSparkMax armNEO = new CANSparkMax(Constants.armNEOPin, CANSparkMaxLowLevel.MotorType.kBrushless);
// 	private static CANDigitalInput revNeoLimitSwitch = armNEO.getReverseLimitSwitch(LimitSwitchPolarity.kNormallyOpen); 
// 	private static CANDigitalInput fwdNeoLimitSwitch = armNEO.getForwardLimitSwitch(LimitSwitchPolarity.kNormallyOpen);

// 	private static int encoderError, encoderValue, encoderVelocity;
...
// 	}
// 	public static int getEncoderError(){
// 		return encoderError;
// 	}
