...
public class FieldElement extends PathProperties {
    ...
    //Scorable elements
    public static final FieldElement LoadingStation = new FieldElement("LoadingStation", RobotState.HATCHL1BACKWARDSAUTO, ScorablePosition.NONE);
    public static final FieldElement ROCKETFRONT = new FieldElement("Rocket", RobotState.HATCHL1FORWARDS, ScorablePosition.FRONT);
    public static final FieldElement ROCKETFRONT2 = new FieldElement("Rocket", RobotState.HATCHL2FORWARDS, ScorablePosition.FRONT);
